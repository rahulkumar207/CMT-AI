					...
					<div className="row content align-items-center">
						<div className="col-lg-6 col-md-12 mb-lg-0 mb-5">
							<div className="pe-2">
								...
								<Link href="/page-contact-3" className="ms-md-3  ms-3 mt-md-0  btn btn-hero btn-outline-secondary btn-outline-secondary1 hover-up" data-aos="fade-zoom-in" data-aos-delay={500}>
