			...
			<Layout >
				...
				<section className="section-services-details pt-80">
					<div className="container">
						<img className="rounded-3" src="/assets/imgs/services-details/img-1.png" alt="cmtai" />
						<div className="row">
						...
						<div className="d-flex flex-lg-row flex-column align-items-lg-end">
							<h5 className="fw-regular ds-5 text-white me-auto">
								...
								<span className="fw-bold">Your <br />
									Business</span>
								with
								<span className="fw-bold">cmtai's <br />
									Innovative</span>
								Services
							</h5>
							<div className="mt-lg-0 mt-8">
								...
								<div className="d-flex flex-md-row flex-column align-items-center">
									...
									<div className="ms-3 mt-md-0 mt-3">
										<img src="/assets/imgs/services-details/brand-1.svg" alt="cmtai" />
									</div>
									<div className="ms-3 mt-md-0 mt-3">
										<img src="/assets/imgs/services-details/brand-2.svg" alt="cmtai" />
									</div>
								</div>
							</div>
						</div>
						<img className="position-absolute top-0 end-0" src="/assets/imgs/services-details/bg-line-1.png" alt="cmtai" />
						<img className="position-absolute bottom-0 start-0" src="/assets/imgs/services-details/bg-line-2.png" alt="cmtai" />
					</div>
				</div>
				{/*Testimonial 2*/}
