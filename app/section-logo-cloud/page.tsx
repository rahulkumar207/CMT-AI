							...
							<div className="carouselTicker carouselTicker-right my-7 position-relative z-1">
								<ul className="carouselTicker__list">
									<Marquee direction="right">
										...
										<li className="carouselTicker__item">
											<img src="/assets/imgs/logo-cloud/logo-2.png" alt="cmtai" />
										</li>
										<li className="carouselTicker__item">
											<img src="/assets/imgs/logo-cloud/logo-3.png" alt="cmtai" />
										</li>
										<li className="carouselTicker__item">
											<img src="/assets/imgs/logo-cloud/logo-4.png" alt="cmtai" />
										</li>
										<li className="carouselTicker__item">
											{/* <img src="/assets/imgs/logo-cloud/logo-5.png" alt="cmtai"> */}
										...
										<li className="carouselTicker__item">
											<img src="/assets/imgs/logo-cloud/logo-6.png" alt="cmtai" />
										</li>
										<li className="carouselTicker__item">
											<img src="/assets/imgs/logo-cloud/logo-7.png" alt="cmtai" />
										</li>
										<li className="carouselTicker__item">
											<img src="/assets/imgs/logo-cloud/logo-4.png" alt="cmtai" />
										</li>
							...
							<div className="col-lg-6">
								...
								<div className="carouselTicker carouselTicker-left position-relative z-1 mt-lg-0 mt-8">
									<ul className="carouselTicker__list">
										<Marquee>
											<li className="carouselTicker__item">
												<img className="rounded-4" src="/assets/imgs/logo-cloud-2/logo-1.png" alt="cmtai" />
											</li>
											<li className="carouselTicker__item">
												<img className="rounded-4" src="/assets/imgs/logo-cloud-2/logo-2.png" alt="cmtai" />
											</li>
											<li className="carouselTicker__item">
												<img className="rounded-4" src="/assets/imgs/logo-cloud-2/logo-3.png" alt="cmtai" />
											</li>
											<li className="carouselTicker__item">
												<img className="rounded-4" src="/assets/imgs/logo-cloud-2/logo-4.png" alt="cmtai" />
											</li>
										</Marquee>
									</ul>
								</div>
								<div className="carouselTicker carouselTicker-right mt-6 position-relative z-1">
									<ul className="carouselTicker__list">
										<Marquee direction="right">
											<li className="carouselTicker__item">
												<img className="rounded-4" src="/assets/imgs/logo-cloud-2/logo-5.png" alt="cmtai" />
											</li>
											<li className="carouselTicker__item">
												<img className="rounded-4" src="/assets/imgs/logo-cloud-2/logo-6.png" alt="cmtai" />
											</li>
											<li className="carouselTicker__item">
												<img className="rounded-4" src="/assets/imgs/logo-cloud-2/logo-7.png" alt="cmtai" />
											</li>
										</Marquee>
									</ul>
								</div>
						...
						<div className="row">
							...
							<div className="carouselTicker carouselTicker-right my-7 position-relative z-1">
								<ul className="carouselTicker__list">
									<Marquee direction="right">
										<li className="carouselTicker__item">
											<img src="/assets/imgs/logo-cloud-4/logo-1.svg" alt="cmtai" />
										</li>
										<li className="carouselTicker__item">
											<img src="/assets/imgs/logo-cloud-4/logo-2.svg" alt="cmtai" />
										</li>
										<li className="carouselTicker__item">
											<img src="/assets/imgs/logo-cloud-4/logo-3.svg" alt="cmtai" />
										</li>
										<li className="carouselTicker__item">
											<img src="/assets/imgs/logo-cloud-4/logo-4.svg" alt="cmtai" />
										</li>
										<li className="carouselTicker__item">
											<img src="/assets/imgs/logo-cloud-4/logo-5.svg" alt="cmtai" />
										</li>
										<li className="carouselTicker__item">
											<img src="/assets/imgs/logo-cloud-4/logo-6.svg" alt="cmtai" />
										</li>
									</Marquee>
								</ul>
							</div>
							...
							<div className="row align-items-center">
								...
								<div className="col-lg-9 ps-lg-8">
									...
									<div className="bg-white py-4 px-4 shadow-1 rounded-2 align-self-center icon-height icon-shape hover-up me-2 mb-2">
										{/* <img src="/assets/imgs/logo-cloud-3/logo-5.svg" alt="cmtai"> */}
									...
									<div className="bg-white py-3 px-3 shadow-1 rounded-2 align-self-center icon-height icon-shape hover-up me-2 mb-2">
										<img className="filter-invert" src="/assets/imgs/logo-cloud-3/logo-13.svg" alt="cmtai" />
									</div>
									<div className="bg-white py-3 px-3 shadow-1 rounded-2 align-self-center icon-height icon-shape hover-up me-2 mb-2">
										<img src="/assets/imgs/logo-cloud-3/logo-11.svg" alt="cmtai" />
									</div>
